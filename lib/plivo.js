...
var request_optional = function (action, method, params, callback) {
};
...
plivo.get_number = function (params, callback) {
...
Response.prototype = {
    ...
    add: function (new_element, body, attributes) {
        ...
        new_element.init(new_element.element, body, attributes);
        return new_element;
    },
